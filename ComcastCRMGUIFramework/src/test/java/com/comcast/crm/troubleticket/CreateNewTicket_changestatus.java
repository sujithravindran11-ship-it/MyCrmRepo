...
public class CreateNewTicket_changestatus {
	...
	public static void main(String[] args) throws Exception{
		...
		// get utility objecct classes
				...
				//navigate back to troubletickets
				driver.findElement(By.linkText("Trouble Tickets")).click();
				
				//add ticketno in search box
				driver.findElement(By.name("search_text")).sendKeys(tktno);
