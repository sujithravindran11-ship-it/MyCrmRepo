...
public class ObjRepo_CreateLeadsWithuserAssig {
	...
	public void CreateLeads() throws Exception {
		...
		String user = elib.getStringData("leads", 2, 0);
		...
		// click on user
		clp.getUserradio().click();
		WebElement userselectElement = clp.getUserdrpdown();
		...
		boolean usercheck = userprint.contains(user);
